...
// node_modules/zoomist/zoomist.js
var Zt = Object.defineProperty;
var Vt = (s, t, e) => t in s ? Zt(s, t, { enumerable: true, configurable: true, writable: true, value: e }) : s[t] = e;
var T = (s, t, e) => (Vt(s, typeof t != "symbol" ? t + "" : t, e), e);
var Ut = (s, t, e) => {
  if (!t.has(s))
...
var ot = (s) => document.contains(U(s));
var Yt = (s) => {
  if (!s)
    return false;
  try {
...
var St = (s) => typeof s == "function";
var B = (s) => !isNaN(Number(s));
var at = (s) => s == null;
var U = (s) => s instanceof HTMLElement ? s : document.querySelector(s);
var rt = (s, t) => t ? s.closest(`.${t}`) : null;
var w = (s) => {
...
var bt = (s) => s.length >= 2 ? Math.hypot(s[0].clientX - s[1].clientX, s[0].clientY - s[1].clientY) : 0;
var M = (s, t) => {
...
var R = (s, t, e) => Math.min(Math.max(s, t), e);
var D = (s) => {
...
var vt = `${p}-wrapper`;
var ct = `${p}-image`;
var Gt = `${p}-not-draggable`;
var jt = `${p}-not-wheelable`;
var x = `${p}-slider`;
var Pt = `${p}-slider-wrapper`;
var Ft = `${p}-slider-bar`;
var qt = `${p}-slider-button`;
var k = `${p}-zoomer`;
var Kt = `${p}-zoomer-button`;
var mt = `${p}-zoomer-icon`;
var ht = `${p}-zoomer-in`;
var dt = `${p}-zoomer-out`;
var ut = `${p}-zoomer-reset`;
var Jt = `${p}-zoomer-disabled`;
var Qt = {
  tabindex: "0",
  role: "slider",
...
var ne = typeof window < "u" && typeof window.document < "u";
var L = ne && "ontouchstart" in window;
var ie = L ? "touchstart" : "mousedown";
var H = L ? "touchmove" : "mousemove";
var Z = L ? "touchend" : "mouseup";
var oe = "wheel";
var ae = ["left", "right", "center"];
var re = ["top", "bottom", "center"];
var Tt = "--scale";
var Dt = "--translate-x";
var wt = "--translate-y";
var le = "--value";
...
var Ee = {
  ...
  destroy(s = false) {
    ...
    return this.mounted && (this.emit("beforeDestroy", this), n.abort(), this.destroyModules(), s && e && (this.reset(), e.removeAttribute("style")), t[p] = null, this.mounted = false, this.emit("destroy", this)), null;
  },
  update(s) {
    const { element: t, controller: e } = this;
    return this.emit("beforeUpdate", this), t[p] = null, this.mounted = false, e.abort(), this.destroyModules(), s && (this.options = Object.assign({}, Xt, Yt(s) && s)), this.init(), this.emit("update", this), this;
  },
  getImageData() {
...
var Se = class {
  ...
  destroySlider() {
    ...
    e === `.${x}` ? (r = t.sliderEl) == null || r.remove() : (a = t.sliderTrack) == null || a.remove(), n == null || n.abort(), t.mounted = false;
  }
  // destroy zoomer
  destroyZoomer() {
    ...
    ].forEach((m) => h(m.target, m.className, m.el)), a == null || a.abort(), t.mounted = false;
  }
};
G = /* @__PURE__ */ new WeakSet(), Rt = function() {
  ...
  M(e, {
    ...
    translateX: 0,
    translateY: 0
  }), t.classList.add(kt), this.mounted = true, this.emit("ready", this);
}, P = /* @__PURE__ */ new WeakSet(), zt = function() {
  ...
  if (L && (i || r)) {
    i && (this.states.dragging = false), r && (this.states.pinching = false);
...
}, F = /* @__PURE__ */ new WeakSet(), At = function(t) {
  ...
  if (n) {
    ...
    t.preventDefault();
  this.states.wheeling || rt(t.target, i) || (this.states.wheeling = true, setTimeout(() => {
    this.states.wheeling = false;
  }, 30), this.zoom(r * e, w(t)), this.emit("wheel", this, this.transform.scale, t));
}, q = /* @__PURE__ */ new WeakSet(), yt = function(t) {
  ...
  const c = (o) => {
    o && o.button !== 0 || (o.preventDefault(), !rt(o.target, i) && (v(r, {
      startX: w(o).clientX,
      startY: w(o).clientY
    }), this.states.dragging = true, this.emit("dragStart", this, { x: n.translateX, y: n.translateY }, o), document.addEventListener(H, l), document.addEventListener(Z, d)));
  }, l = (o) => {
    ...
    o.touches || (this.states.dragging = false, this.emit("dragEnd", this, { x: n.translateX, y: n.translateY }, o), document.removeEventListener(H, l), document.removeEventListener(Z, d));
  };
  c(t);
}, K = /* @__PURE__ */ new WeakSet(), Mt = function(t) {
  ...
  const u = (_) => {
    ...
    v(h, {
      ...
      widthDiff: A,
      heightDiff: y
    }), a && (this.states.dragging = true, this.emit("dragStart", this, { x: n.translateX, y: n.translateY }, _)), c && g.length === 2 && (this.states.pinching = true, this.emit("pinchStart", this, n.scale, _)), document.addEventListener("touchmove", f), document.addEventListener("touchend", E);
  }, f = (_) => {
    const g = _.touches;
    if (!g)
      return;
    ...
    if (Y && g.length === 2 && this.zoomTo(it, false), S) {
    ...
    if (S && !g.length && (this.states.dragging = false, this.emit("dragEnd", this, { x: n.translateX, y: n.translateY }, _)), Y && g.length < 2 && (this.states.pinching = false, this.emit("pinchEnd", this, n.scale, _)), S && g.length === 1) {
  ...
  u(t);
}, J = /* @__PURE__ */ new WeakSet(), Ct = function() {
...
}, tt = /* @__PURE__ */ new WeakSet(), xt = function() {
  ...
  a.classList.add(`${x}-${i}`), V(e, "value", {
    ...
    sliderTrack: c,
    sliderButton: d
  }), O(this, et, $t).call(this), c.append(l, d), a.append(c), r && t.append(a), e.mounted = true;
}, et = /* @__PURE__ */ new WeakSet(), $t = function() {
  ...
  const l = i === "vertical", d = (u) => {
    ...
    this.emit("slideEnd", this, this.getSliderValue(), u), n.sliding = false, document.removeEventListener(H, h), document.removeEventListener(Z, m);
  };
  a.addEventListener(ie, o, { signal: r == null ? void 0 : r.signal });
}, st = /* @__PURE__ */ new WeakSet(), Nt = function() {
  ...
  v(e, {
    ...
    zoomerOutEl: h,
    zoomerResetEl: m
  }), d && (o && d.append(o), h && d.append(h), m && d.append(m), n === `.${k}` && t.append(d)), O(this, nt, Bt).call(this), e.mounted = true;
}, nt = /* @__PURE__ */ new WeakSet(), Bt = function() {
...
//# sourceMappingURL=zoomist.js.map
